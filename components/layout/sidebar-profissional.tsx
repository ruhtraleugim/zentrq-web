...
const nav = [
  { href: '/profissional/jobs', label: 'Oportunidades' },
  { href: '/profissional/propostas', label: 'Minhas Propostas' },
  { href: '/profissional/perfil', label: 'Perfil' },
]

export function SidebarProfissional() {
